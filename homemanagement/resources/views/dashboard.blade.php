  ...
  <div class="bg-gray-100 dark:bg-gray-900 dark:text-white text-gray-600 h-screen flex overflow-hidden text-sm">
    ...
    <div class="flex-grow overflow-hidden h-full flex flex-col">
      ...
      <div class="flex-grow flex overflow-x-hidden">
        ...
        <!-- left side user  -->
        @include('layouts/users/adminleftuser')

        <div class="flex-grow bg-white dark:bg-gray-900 overflow-y-auto">

          <!-- user nav bar  -->
           @include('layouts/users/adminusernavbar')
            ...
            <table class="w-full text-left">
              ...
              <tbody class="text-gray-600 dark:text-gray-100">
                ...
                <tr>
                  ...
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 md:table-cell hidden">
                    Macbook Pro 13"</td>
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 text-red-500">- $1.499.99
                  </td>
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                    <div class="flex items-center">
                      <div class="sm:flex hidden flex-col">
                ...
                <tr>
                  ...
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 md:table-cell hidden">
                    Invoice No: 37401</td>
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 text-green-500">+ $60.00
                  </td>
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                    <div class="flex items-center">
                      <div class="sm:flex hidden flex-col">
                ...
                <tr>
                  ...
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 md:table-cell hidden">
                    Invoice No: 12993</td>
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 text-green-500">+ $24.00
                  </td>
                  <td class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800">
                    <div class="flex items-center">
                      <div class="sm:flex hidden flex-col">
