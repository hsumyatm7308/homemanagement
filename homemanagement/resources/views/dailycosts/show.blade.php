...
@section('caption','dailycost Show')
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <a href="{{route('dailycosts.index')}}" class="btn btn-secondary btn-sm rounded-0">Close</a>
                ...
                <div class="card border-0 rounded-0 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column align-items-center mb-3">
                            <div class="fw-bold h5 mb-2">{{$dailycost->name}}</div>
                            <div class="text-muted mb-3">
                                <span class="fw-semibold">Amount : {{$dailycost->amount}}</span>
                            </div>
                            <div style="width:200px; height:200px; background:#fcf2f2;">
                                <img src="{{ asset($dailycost->image) }}" alt="{{ $dailycost->name }}" width="200" />
                            </div>
                            ...
                            <div class="row g-0 mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div>{{$dailycost['category']['title']}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-0 mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div>{{date('d M Y',strtotime($dailycost->created_at))}} | {{date('h:i:s A',strtotime($dailycost->created_at))}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-0 mb-2">
                                ...
                                <div class="col ps-3">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div>{{date('d M Y',strtotime($dailycost->updated_at))}} | {{date('h:i:s A',strtotime($dailycost->updated_at))}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
