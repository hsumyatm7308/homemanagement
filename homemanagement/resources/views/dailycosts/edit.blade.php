                    ...
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-sm-center">
                                <img src="{{asset($dailycost->image)}}" width="200" alt="{{$dailycost->title}}" />
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-sm rounded-0"
                                placeholder="Enter your Title name" value="{{$dailycost->name}}" />
                        </div>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="number" name="amount" id="amount" class="form-control form-control-sm rounded-0"
                                placeholder="Class fee" value="{{$dailycost->amount}}" />
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <textarea name="remark" id="remark" class="form-control form-control-lg rounded-0"
                                rows="5" placeholder="Say Something...">{{$dailycost->remark}}</textarea>
